...
(
    ...
    id_acta bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    fecha date,
...
CREATE TABLE IF NOT EXISTS public.asignar_tareas
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    sprint_id integer,
    nombre_tarea character varying(255) COLLATE pg_catalog."default" NOT NULL,
    responsable character varying(255) COLLATE pg_catalog."default" NOT NULL,
    fecha_entrega date NOT NULL,
    entregable text COLLATE pg_catalog."default",
    CONSTRAINT asignar_tareas_pkey PRIMARY KEY (id)
);
...
(
    ...
    fecha_ini date,
    fecha_fin date,
    nombre_plan character varying COLLATE pg_catalog."default",
...
(
    ...
    plan_grupo_id_docente integer NOT NULL,
    id_estudiante integer NOT NULL,
    id_tarea bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    detalle character varying COLLATE pg_catalog."default" NOT NULL,
    archivo bytea,
    path character varying COLLATE pg_catalog."default",
    entregado boolean,
    CONSTRAINT tarea_pkey PRIMARY KEY (grupo_nombre, plan_grupo_id_docente, id_estudiante)
);

CREATE TABLE IF NOT EXISTS public.tipo_plan
(
    id_plan bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    nombre character varying COLLATE pg_catalog."default" NOT NULL,
    detalle character varying COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.asignar_tareas
    ADD CONSTRAINT asignar_tareas_sprint_id_fkey FOREIGN KEY (sprint_id)
...
ALTER TABLE IF EXISTS public.tarea
    ADD CONSTRAINT tarea_plan_grupo_nombre_plan_grupo_id_docente_fkey FOREIGN KEY (grupo_nombre, plan_grupo_id_docente)
    REFERENCES public.plan (grupo_nombre, grupo_id_docente) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
